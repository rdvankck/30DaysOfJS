...
<head>
    ...
    <style>
      body {
        background: linear-gradient(135deg, #1a4f3a 0%, #2d5a3d 50%, #0f2419 100%);
      ...
      .form-title {
        font-family: 'Trade Gothic Pro', 'Arial Black', sans-serif;
      ...
      .content-wrapper::before {
        ...
        right: 0;
        bottom: 0;
        background: url('data:image/svg+xml,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100"><defs><pattern id="subtle-grain" patternUnits="userSpaceOnUse" width="50" height="50"><circle cx="10" cy="10" r="0.3" fill="%23d4af37" opacity="0.02"/><circle cx="40" cy="20" r="0.2" fill="%23d4af37" opacity="0.015"/><circle cx="25" cy="40" r="0.25" fill="%23d4af37" opacity="0.018"/></pattern></defs><rect width="100" height="100" fill="url(%23subtle-grain)"/></svg>') repeat;
        pointer-events: none;
        border-radius: 28px;
      }
      ...
      .map-container.details-visible #place-details-panel {
        width: 50%;
        padding: 0 !important;
      }

      #place-details-panel img {
        width: 100%;
        height: 180px;
        object-fit: cover;
        border-radius: .5rem;
      ...
      .form-control {
        border: 2px solid rgba(26, 79, 58, 0.3);
        border-radius: 16px;
        padding: 16px 20px;
        font-size: 1rem;
      ...
      .btn-primary {
        background: linear-gradient(135deg, #1a4f3a 0%, #2d5a3d 50%, #1a4f3a 100%);
      ...
      .btn-primary:hover {
        ...
        border-color: #d4af37;
        color: #ffffff;
        background: linear-gradient(135deg, #2d5a3d 0%, #1a4f3a 50%, #2d5a3d 100%);
      }
      ...
      .btn-premium-submit {
        ...
        text-transform: uppercase;
        letter-spacing: 1px;
        background: linear-gradient(135deg, #1a4f3a 0%, #2d5a3d 25%, #1a4f3a 50%, #2d5a3d 75%, #1a4f3a 100%);
      ...
      .btn-premium-submit:active {
        ...
        box-shadow: 0 15px 30px rgba(26, 79, 58, 0.3);
      }
      ...
      .btn-premium-submit:hover .submit-icon {
      ...
      /* Premium Pub Info Section */
      .pub-info {
        background: rgba(255, 255, 255, 0.1);
        border: 1px solid rgba(26, 79, 58, 0.3);
        border-radius: 20px;
        padding: 30px;
        margin-top: 30px;
      ...
      .pub-info::before {
        ...
        right: 0;
        height: 2px;
        background: linear-gradient(90deg, transparent, #1a4f3a, transparent);
        opacity: 0.7;
      }
      ...
      .pub-info .text-muted {
        color: rgba(13, 40, 24, 0.7) !important;
        font-size: 1rem;
        line-height: 1.6;
      }
      ...
      .pub-card.selected {
          border-color: #1a4f3a;
          background: rgba(26, 79, 58, 0.05);
          box-shadow: 
            0 12px 35px rgba(26, 79, 58, 0.2),
            inset 0 1px 0 rgba(26, 79, 58, 0.1);
      ...
      /* Make address text smaller on mobile */
      ...
      .pub-card.selected .pub-card-button {
          background: #1a4f3a;
          color: white;
          border-color: #1a4f3a;
      }

      .pub-card-button .select-text { display: inline; }
      .pub-card-button .selected-text { display: none; }

      .pub-card.selected .pub-card-button .select-text { display: none; }
      .pub-card.selected .pub-card-button .selected-text { display: inline; }
      
      #place-details-panel h5 {
          color: #1a4f3a;
          font-weight: 700;
      }
      ...
      /* Mobile and Tablet Specific (down from lg) */
      @media (max-width: 991.98px) {
        body { padding: 10px; }
        .content-wrapper { padding: 20px; }
        
        #pubList { display: none; }
        #place-details-panel { display: none !important; }

        .map-container, .map-container.details-visible {
            height: 350px;
        }
        #gmp-map, .map-container.details-visible #gmp-map {
            width: 100% !important;
        }

        #pubList-mobile .pub-card {
            margin: 0 auto;
            max-width: 95%;
            box-shadow: none;
            border: none;
        ...
        #pubList-mobile .carousel-inner {
            padding: 0 20px; /* Reduce padding since buttons are outside */
        }

        /* Smaller Carousel Controls for Mobile */
        #pubList-mobile .carousel-control-prev-icon,
        #pubList-mobile .carousel-control-next-icon {
            width: 0.8rem;
            height: 0.8rem;
            background-size: 60%;
            margin-top: 0;
            background-color: rgba(26, 79, 58, 0.8);
            border-radius: 50%;
            padding: 8px;
        }
        #pubList-mobile .carousel-control-prev {
            left: -15px;
            width: 30px;
            height: 30px;
            top: 50%;
            ...
            border-radius: 50%;
            background-color: rgba(26, 79, 58, 0.1);
            z-index: 10;
        }
        #pubList-mobile .carousel-control-next {
            right: -15px;
            width: 30px;
            height: 30px;
            top: 50%;
        ...
        /* Remove underline from Nearby Pubs heading on mobile */
        #pubInfo h5 {
      ...
      /* Thank You Page - World Class Jameson UI */
      #thankYouPage {
        display: flex;
        flex-direction: column;
        justify-content: center;
      ...
      .social-icons-container, .website-link-container {
      ...
      .social-icons-container::before, .website-link-container::before {
        content: '';
        position: absolute;
        top: 0;
        left: 0;
      ...
      .social-icons-container:hover, .website-link-container:hover {
      ...
      .social-icons-container:hover::before, .website-link-container:hover::before {
        opacity: 1;
      }
      ...
      .social-icons a::before {
        ...
        width: 0;
        height: 0;
        background: radial-gradient(circle, #d4af37, #f4e4bc);
      ...
      /* Show pub info lines only on mobile devices */
      @media (max-width: 991.98px) {
        .pub-card-info-line {
      ...
      .pub-card.selected .pub-card-photo::after {
...
<body>
    <div class="container" id="formContainer" %%=IIF(@isSubmitted == "true", 'style="display: none;"', '')=%%>
        <div class="form-card">
            <div class="form-title">📍 UK Postcode Lookup & Pub Finder</div>
            <div class="content-wrapper">
                <form method="post" id="mainForm">
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <button type="button" class="btn btn-primary" onclick="updateMap()">🔍 Search</button>
                                        </div>
                                        <small class="form-text text-muted">Enter your UK postcode to find nearby pubs.</small>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-8 d-flex flex-column">
                            <h5 class="text-center d-lg-none mb-3 py-3 fw-bold">🍺 Nearby Pubs</h5>
                            <div class="right-section-wrapper">
                                <div class="map-container">
                                    <gmp-map id="gmp-map" center="51.5074,-0.1278" zoom="10"></gmp-map>
                                    <div id="place-details-panel">
                                        <gmp-place-details>
                                            <gmp-place-details-place-request id="place-request"></gmp-place-details-place-request>
                    ...
                    <div class="row mt-4">
                        <div class="col-12">
                            <div id="pubInfo" class="pub-info" style="display: none;">
                                <h5 class="text-center text-sm-start d-none d-lg-block">🍺 Nearby Pubs</h5>
                                <p class="text-muted d-none d-lg-block">Select a pub from the list below to see details and submit your choice.</p>
                                
                                <!-- Desktop Grid -->
                                <div id="pubList"></div>
                                
                                <!-- Mobile Carousel -->
                                <div id="pubList-mobile" class="carousel slide" data-bs-interval="false">
                                    <div class="carousel-inner">
                                        <!-- Populated by JS -->
                                    </div>
                                    <button class="carousel-control-prev" type="button" data-bs-target="#pubList-mobile" data-bs-slide="prev">
                                        <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                                        <span class="visually-hidden">Previous</span>
                                    </button>
                                    <button class="carousel-control-next" type="button" data-bs-target="#pubList-mobile" data-bs-slide="next">
                              ...
                              <div id="directionsSection" class="text-center mt-3 d-lg-none">
    <button id="getDirectionsBtn" type="button" class="btn btn-success">
        <i class="fas fa-map-marker-alt"></i> Get Directions
                    ...
                    <input type="hidden" id="selectedBar" name="selectedBar">
                    <input type="hidden" id="outlet_local_id" name="outlet_local_id">
                    <input type="hidden" id="outlet_address_street_1" name="outlet_address_street_1">
                    <input type="hidden" id="outlet_address_postalcode" name="outlet_address_postalcode">
                    <input type="hidden" id="outlet_address_city" name="outlet_address_city">
                    <input type="hidden" id="outlet_address_location_lon" name="outlet_address_location_lon">
                    <input type="hidden" id="outlet_address_location_lat" name="outlet_address_location_lat">

                    <div id="submitSection" class="text-center mt-4" style="display: none;">
                        <button type="submit" form="mainForm" class="btn btn-premium-submit px-5 py-3">
                            <span class="submit-icon">🥃</span>
                            <span class="submit-text">Submit My Selection</span>
                        </button>
                    </div>
                </form>
            </div>
    ...
    <!-- Thank You Page - World Class Jameson UI -->
    <div id="thankYouPage" %%=IIF(@isSubmitted == "true", 'style="display: flex;"', 'style="display:none;"')=%%>
        <div class="thank-you-hero">
          
            <h1>Your Journey<br>Has Been Saved</h1>
            <p>Thank you for joining the Jameson community. We have received your application and will be in touch with you soon to discuss the next steps of your whiskey journey with us.</p>
        </div>
        
        <div class="thank-you-content-wrapper">
            <!-- Social Media Section -->
            <div class="social-icons-container">
                <div class="container-title">Follow Our Journey</div>
                <div class="social-icons">
                    <a href="https://www.facebook.com/JamesonWhiskey/" target="_blank" aria-label="Facebook" title="Follow us on Facebook">
                        <i class="fab fa-facebook-f"></i>
                    </a>
                    <a href="https://www.instagram.com/jameson_us/" target="_blank" aria-label="Instagram" title="Follow us on Instagram">
                        <i class="fab fa-instagram"></i>
                    </a>
                    <a href="https://twitter.com/jamesonwhiskey" target="_blank" aria-label="Twitter" title="Follow us on Twitter">
                        <i class="fab fa-twitter"></i>
                    </a>
                    <a href="https://www.youtube.com/user/jamesonwhiskey" target="_blank" aria-label="YouTube" title="Subscribe to our channel">
            ...
            <div class="website-link-container">
                <div class="container-title">Discover More</div>
                <a href="https://www.jamesonwhiskey.com/en/" class="btn-website" target="_blank">
                    Explore Jameson World
                </a>
            </div>
        </div>
    </div>
